...
alias raspi3="ssh -Y iainstott@192.168.1.3"
...
alias server="ssh -X -C  iainstott@192.168.0.3"
alias servertemp="ssh -Y iainstott@192.168.0.3 'sensors | grep Core'"
...
alias wakebladeserver="ssh iainstott@192.168.0.5 'source /home/iainstott/GitRepo/Scripts/lib/bash/bladeSERVERCRON; turnON'"
alias sleepbladeserver="ssh iainstott@192.168.0.5 'source /home/iainstott/GitRepo/Scripts/lib/bash/bladeSERVERCRON; remoteOFF'" 
